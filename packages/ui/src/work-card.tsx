 ...
 */
type WorkCardImageProps = Pick<ImgHTMLAttributes<HTMLImageElement>, 'src' | 'alt' | 'width' | 'height' | 'className'>
...
export interface WorkCardProps {
  ...
  imageSrc: string
  imageAlt?: string
  /** Tag strings rendered as Badges. */
  tags?: string[]
  /**
   ...
   */
  imageComponent?: ElementType<WorkCardImageProps>
  className?: string
}
